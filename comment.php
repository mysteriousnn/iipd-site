...
} else if (isset($currentComment['text_simple']) && !empty($currentComment['text_simple'])) {
    $simpleText = htmlspecialchars($currentComment['text_simple']);
    $displayText = nl2br($simpleText);
} else {
...
<head>
    ...
    <title><?php echo htmlspecialchars($currentComment['title']); ?> - Ищу интернет подругу/друга</title>
            ...
            <section class="load-level-section" style="border-left: 5px solid var(--orange-color);">
                <div class="level-header">
                    <h2 class="level-title">
                        ...
                        <?php echo htmlspecialchars($currentComment['title']); ?>
                    </h2>
                    <div class="current-level">
                        <i class="fas fa-calendar"></i>
                        <span><?php echo htmlspecialchars($currentComment['date']); ?></span>
                    </div>
                </div>
                ...
                <div class="comment-actions">
                    <button id="share-comment" class="button-link share-button">
                        ...
                        <span>Поделиться комментарием</span>
                    </button>
